package com.bank.bian.servicedesk.model;
...
/**
 * The BIAN control record for this service domain: "Service Ticket Operating Session".
 *
 ...
 * to its asset type (Service Ticket). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Service Ticket Operating Session";
